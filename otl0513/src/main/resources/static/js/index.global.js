...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var css_248z$4 =
        ":root{--fc-small-font-size:.85em;" +
        "--fc-page-bg-color:#fff;" +
        "--fc-neutral-bg-color:hsla(0,0%,82%,.3);" +
        "--fc-neutral-text-color:grey;" +
        "--fc-border-color:#F8A188;" +
        "--fc-button-text-color:#fff;" +
        "--fc-button-bg-color:#F8A188;" +
        "--fc-button-border-color:#FEC2B1;" +
        "--fc-button-hover-bg-color:#FEC2B1;" +
        "--fc-button-hover-border-color:#FEC2B1;" +
        "--fc-button-active-bg-color:#FEC2B1;" +
        "--fc-button-active-border-color:#FEC2B1;" +
        "--fc-event-bg-color:#3788d8;" +
        "--fc-event-border-color:#FEC2B1;" +
